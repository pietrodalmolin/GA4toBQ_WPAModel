INSERT INTO `steam-mantis-108908.WPA_Events.SB_WidgetClick`
(
SELECT
...
,CASE 
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%sportsbook event table%' THEN 'Homepage'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%carousel%' THEN 'Homepage'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%popular bets%' THEN 'Homepage'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%popular pre-built bets%' THEN 'Homepage'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%event market group%' THEN 'Event Page, across multiple locations'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%sportsbook.category%' THEN 'Category Page'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%sportsbook.competition%' THEN 'Competition Page'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%sportsbook.live-category%' THEN 'Live Page'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%sportsbook.live%' THEN 'Live Page'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%sportsbook.region%' THEN 'Region Page'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%sportsbook.search%' THEN 'After Search'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%sportsbook.starting-soon-tab%' THEN 'Starting Soon Page'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%sportsbook.live-stream-calendar%' THEN 'Live Stream Calendar Page'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%price-boost%' THEN 'Price Boost Page'
ELSE 'Other Locations'
END AS AtB_by_Location
,CASE 
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%event market group%' THEN 'Event Page'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%event table%' THEN 'Events Table'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%outrights%' THEN 'Events Table'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%carousel%' THEN 'Carousel'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%cards%' THEN 'Cards'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%popular bets%' THEN 'Popular Bets'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%popular pre-built bets%' THEN 'Popular Pre-Built Bets'
WHEN LOWER(EventAction) LIKE '%slip on%' AND LOWER(EventAction) LIKE '%price-boost%' THEN 'Price Boost (Page)'
ELSE 'Other Widgets'
END AS AtB_by_Widget
,CASE 
WHEN STRPOS(EventAction, 'Group') > 0 THEN 
LTRIM(REPLACE(REPLACE(SUBSTR(EventAction, STRPOS(EventAction, 'Group') + 5), '(', ''), ')', '')) 
ELSE NULL 
