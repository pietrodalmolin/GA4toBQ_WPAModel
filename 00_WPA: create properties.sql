...
SET property_ids = [
    '479302236' -- BETSSON UK GA4 [WEB], Example
];
...
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Bonus_EventPhase') 
AS Bonus_EventPhase
,COALESCE((SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Bonus_ID'),
CAST((SELECT value.int_value FROM UNNEST(event_params) WHERE key = 'Bonus_ID') AS STRING))
AS Bonus_ID
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Bonus_Title')
AS Bonus_Title
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Bonus_Type')
AS Bonus_Type
...
AS campaign_id
,COALESCE((SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'CardClicked'),
CAST((SELECT value.int_value FROM UNNEST(event_params) WHERE key = 'CardClicked') AS STRING))
AS CardClicked
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Casino_CouponType')
AS Casino_CouponType
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Casino_EventDetails')
AS Casino_EventDetails
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'CategoryDetails')
AS CategoryDetails
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'CD_Position')
AS CD_Position
...
AS currency
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Customer_Status_End')
AS Customer_Status_End_event_params
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Customer_Status_Event')
AS Customer_Status_Event
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'dclid')
AS dclid
,(SELECT value.int_value FROM UNNEST(event_params) WHERE key = 'debug_mode')
AS debug_mode
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Direction')
AS Direction
...
AS entrances
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'EventAction')
AS EventAction
,COALESCE((SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'EventDetails'),
CAST((SELECT value.int_value FROM UNNEST(event_params) WHERE key = 'EventDetails') AS STRING),
CAST((SELECT value.float_value FROM UNNEST(event_params) WHERE key = 'EventDetails') AS STRING),
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'EventDetails') AS STRING))
AS EventDetails
,(SELECT value.int_value FROM UNNEST(event_params) WHERE key = 'firebase_conversion')
AS firebase_conversion
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Full_Page_Url')
AS Full_Page_Url
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Full_Url')
AS Full_Url
,(SELECT value.int_value FROM UNNEST(event_params) WHERE key = 'ga_session_id')
AS ga_session_id
,(SELECT value.int_value FROM UNNEST(event_params) WHERE key = 'ga_session_number')
AS ga_session_number
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Game_Category')
AS Game_Category
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Game_Collection_Position')
AS Game_Collection_Position
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Game_Name')
AS Game_Name
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Game_Provider')
AS Game_Provider
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'GameProvider')
AS GameProvider
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'gclid')
AS gclid
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'gclsrc')
AS gclsrc
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'GUID_Event')
AS GUID_Event
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'ignore_referrer')
AS ignore_referrer
,(SELECT value.int_value FROM UNNEST(event_params) WHERE key = 'Interface_BannerPositon')
AS Interface_BannerPositon
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Interface_Brand')
AS Interface_Brand
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Interface_CardClicked')
AS Interface_CardClicked
,COALESCE(
...
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Jurisdiction')
AS Jurisdiction
...
AS Login_Balance
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Login_Currency')
AS Login_Currency
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Login_Method')
AS Login_Method
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Login_Status')
AS Login_Status
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'LoginStatus')
AS LoginStatus
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'medium')
AS medium
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Native_App_Name')
AS Native_App_Name
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Native_App_Version')
AS Native_App_Version
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'page_hostname')
AS page_hostname
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'page_location')
AS page_location
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Page_Medium')
AS Page_Medium
...
AS page_title
,(SELECT value.int_value FROM UNNEST(event_params) WHERE key = 'Payment_Amount')
AS Payment_Amount
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Payment_Currency')
AS Payment_Currency
...
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Payment_DepositType')
AS Payment_DepositType
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Payment_Method')
AS Payment_Method
,(SELECT value.int_value FROM UNNEST(event_params) WHERE key = 'Payment_Sel_Amount')
AS Payment_Sel_Amount
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Payment_Sel_Currency')
AS Payment_Sel_Currency
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Payment_Status')
AS Payment_Status
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Product_Theme')
AS Product_Theme
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Raw_HostName')
AS Raw_HostName
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Registration_Type')
...
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'session_engaged') AS STRING))
AS session_engaged
,(SELECT value.int_value FROM UNNEST(event_params) WHERE key = 'Slide_Number')
AS Slide_Number
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'source')
AS source
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Sportsbook_BetType')
AS Sportsbook_BetType
,COALESCE(
...
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Sportsbook_CompetitionDetails')
AS Sportsbook_CompetitionDetails
,(SELECT value.int_value FROM UNNEST(event_params) WHERE key = 'Sportsbook_CouponDetails')
AS Sportsbook_CouponDetails
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Sportsbook_CouponType')
AS Sportsbook_CouponType
...
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Sportsbook_EventPhase')
AS Sportsbook_EventPhase
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Sportsbook_MarketName')
AS Sportsbook_MarketName
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Sportsbook_MarketTemplateID')
AS Sportsbook_MarketTemplateID
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Sportsbook_RememberStakeFlag')
AS Sportsbook_RememberStakeFlag
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Sportsbook_TabName')
AS Sportsbook_TabName
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Sportsbook_ViewType')
AS Sportsbook_ViewType
,COALESCE(
...
AS Sub_Area
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Technical_AdBlocker')
AS Technical_AdBlocker
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Technical_Error')
AS Technical_Error
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Technical_EventName')
AS Technical_EventName
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Technical_GTMContainerInfo')
AS Technical_GTMContainerInfo
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Technical_PageType')
AS Technical_PageType
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Technical_PlatformDelivery')
AS Technical_PlatformDelivery
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Technical_PlatformEnv')
AS Technical_PlatformEnv
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Technical_PlatformName')
AS Technical_PlatformName
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Technical_PlatformUsed')
AS Technical_PlatformUsed
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Technical_RawUserAgentInfo')
AS Technical_RawUserAgentInfo
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Technical_ReleaseName')
AS Technical_ReleaseName
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Technical_ReleaseVersion')
AS Technical_ReleaseVersion
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Technical_ScreenOrientation')
AS Technical_ScreenOrientation
...
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Technical_TargetingConsent')
AS Technical_TargetingConsent
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Technical_WindowType')
AS Technical_WindowType
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'term')
AS term
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Tournament_ID')
AS Tournament_ID
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Tournament_Type')
AS Tournament_Type
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'transaction_id')
AS transaction_id
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'User_Country')
AS User_Country
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'User_CustomerLevel')
AS User_CustomerLevel
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'User_Reg_Country')
AS User_Reg_Country
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'User_Reg_KYCStatus')
AS User_Reg_KYCStatus_event_params
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'User_Reg_Method')
AS User_Reg_Method
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'User_Reg_Step')
AS User_Reg_Step
,(SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'User_UniqueID_Event')
AS User_UniqueID_Event
,(SELECT value.int_value FROM UNNEST(event_params) WHERE key = 'value')
AS value

-- Extracting values from user_properties using UNNEST()

,(SELECT value.string_value FROM UNNEST(user_properties) WHERE key = 'Customer_Status_Acq')
AS Customer_Status_Acq
,(SELECT value.string_value FROM UNNEST(user_properties) WHERE key = 'Customer_Status_End')
AS Customer_Status_End_user_properties
,(SELECT value.string_value FROM UNNEST(user_properties) WHERE key = 'Customer_Status_Start')
AS Customer_Status_Start
,(SELECT value.string_value FROM UNNEST(user_properties) WHERE key = 'Customer_Status_User')
AS Customer_Status_User
,(SELECT value.string_value FROM UNNEST(user_properties) WHERE key = 'GUID_User')
AS GUID_User
...
AS User_UniqueID
,(SELECT value.string_value FROM UNNEST(user_properties) WHERE key = 'User_UniqueID_User')
AS User_UniqueID_User
...
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'Custom_Funnel') AS STRING))
AS Custom_Funnel
...
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'ElementClicked') AS STRING))
AS ElementClicked
...
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'ElementTotal') AS STRING))
AS ElementTotal
...
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'End_Date') AS STRING))
AS End_Date
...
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'EventLabel') AS STRING))
AS EventLabel
...
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'Filters_Applied') AS STRING))
AS Filters_Applied
...
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'Game_ID') AS STRING))
AS Game_ID
...
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'Interface_BannerPosition') AS STRING))
AS Interface_BannerPosition
...
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'Optimizely_Exp_Event') AS STRING))
AS Optimizely_Exp_Event
...
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'Optimizely_Exp_User') AS STRING))
AS Optimizely_Exp_User
...
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'ParentMenu') AS STRING))
AS ParentMenu
...
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'Payment_DepositFlow') AS STRING))
AS Payment_DepositFlow
...
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'Payment_WithdrawalFlow') AS STRING))
AS Payment_WithdrawalFlow
...
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'Search_Provider') AS STRING))
AS Search_Provider
...
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'Sort_Applied') AS STRING))
AS Sort_Applied
...
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'Sportsbook_BetMarket') AS STRING))
AS Sportsbook_BetMarket
...
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'Start_Date') AS STRING))
AS Start_Date
,COALESCE((SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Product_Type'),
CAST((SELECT value.int_value FROM UNNEST(event_params) WHERE key = 'Product_Type') AS STRING),
CAST((SELECT value.float_value FROM UNNEST(event_params) WHERE key = 'Product_Type') AS STRING),
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'Product_Type') AS STRING))
AS Product_Type
,COALESCE((SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'TabName'),
CAST((SELECT value.int_value FROM UNNEST(event_params) WHERE key = 'TabName') AS STRING),
CAST((SELECT value.float_value FROM UNNEST(event_params) WHERE key = 'TabName') AS STRING),
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'TabName') AS STRING))
AS TabName
,COALESCE((SELECT value.string_value FROM UNNEST(event_params) WHERE key = 'Sort_Order'),
CAST((SELECT value.int_value FROM UNNEST(event_params) WHERE key = 'Sort_Order') AS STRING),
CAST((SELECT value.float_value FROM UNNEST(event_params) WHERE key = 'Sort_Order') AS STRING),
CAST((SELECT value.double_value FROM UNNEST(event_params) WHERE key = 'Sort_Order') AS STRING))
AS Sort_Order
