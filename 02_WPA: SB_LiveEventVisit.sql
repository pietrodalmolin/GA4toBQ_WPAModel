CREATE OR REPLACE TABLE `steam-mantis-108908.WPA_Tables.SB_LiveEventVisit`
...
WHERE wpa.date <='2025-01-28' and wpa.date>='2024-10-01'
--EVENT FILTERS
AND Event_Name='Sportsbook' --filter event_name
AND EventAction='Live Event Visit' --filter event_action
