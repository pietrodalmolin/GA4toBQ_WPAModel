CREATE OR REPLACE TABLE `steam-mantis-108908.WPA_Tables.CA_LoginFormOpen`
...
--EVENT FILTERS
AND Event_Name='Login_Funnel' --filter event_name
AND EventAction='Login Form Open' --filter event_action
