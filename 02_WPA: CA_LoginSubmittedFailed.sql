CREATE OR REPLACE TABLE `steam-mantis-108908.WPA_Tables.CA_LoginSubmittedFailed`
...
WHERE wpa.date<'2024-11-28'
--EVENT FILTERS
AND Event_Name='Login_Funnel'
AND REGEXP_CONTAINS(EventAction, r'Login Submitted|Login Failed')
