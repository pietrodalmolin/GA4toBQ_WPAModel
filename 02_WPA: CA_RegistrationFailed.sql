CREATE TABLE `steam-mantis-108908.WPA_Tables.CA_RegistrationFailed`
...
WHERE wpa.date<'2024-11-22'
--EVENT FILTERS
AND Event_Name='Registration_Funnel' --filter event_name
AND EventAction='Registration Failed' --filter event_action
