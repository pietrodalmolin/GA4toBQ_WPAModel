...
--IN THE VIEW USED TO CREATE EVENT TABLES
...
--SELECT * FROM steam-mantis-108908.WPA.270412437 UNION ALL -- EUROPEBET GA4 [WEB] EXCLUDED
...
SELECT * FROM steam-mantis-108908.WPA.479302236
