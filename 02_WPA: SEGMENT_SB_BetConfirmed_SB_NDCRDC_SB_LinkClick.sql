INSERT INTO `steam-mantis-108908.WPA_Events.SEGMENT_SB_BetConfirmed_SB_NDCRDC_SB_LinkClick`
SELECT
  a.property_id,
  a.date,
  a.session_id,
  ...
  a.Event_Count
FROM 
`steam-mantis-108908.WPA_Events.SB_BetConfirmed` a
INNER JOIN `steam-mantis-108908.WPA_Events.SEGMENT_SB_NDCRDC_SB_LinkClick` b
  ON a.session_id = b.session_id
WHERE 
  a.date = TIMESTAMP(DATE_SUB(CURRENT_DATE(), INTERVAL 2 DAY))
