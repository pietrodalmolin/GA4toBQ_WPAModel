CREATE TABLE `steam-mantis-108908.WPA_Tables.CA_CarouselNavigationClick`
...
WHERE wpa.date <='2025-01-25'
--EVENT FILTERS
AND Event_Name='Clicks' --filter event_name
AND EventAction LIKE '%Carousel Navigation Click%' --filter event_action
