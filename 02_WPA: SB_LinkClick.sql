CREATE TABLE `steam-mantis-108908.WPA_Tables.SB_LinkClick`
...
AND EventAction='LinkClick' --filter event_action
AND Content_Group LIKE '%SPORTSBOOK%' --filter event_name
